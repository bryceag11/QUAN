...
from quaternion.qactivation import QReLU, QPReLU, QREReLU
import tqdm
import signal
import sys
import gc
...
class QDenseNetBC(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.features.add_module('relu_final', QPReLU())
...
def train_epoch(model, train_loader, criterion, optimizer, epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_pbar):
        ...
        del outputs, criterion_loss, total_loss
...
def main():
    ...
    model.parameters(),
    lr=0.001,  # Lower initial LR than SGD
    betas=(0.9, 0.999),
    eps=1e-8,
    ...
    # optimizer,
    # milestones=[150, 225],  # As per DenseNet paper
